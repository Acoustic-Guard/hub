...
@DisplayName("SensorMonitorService Tests")
class SensorMonitorServiceImplTest {
    ...
    @InjectMocks
    private SensorMonitorServiceImpl sensorMonitorService;

    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(sensorMonitorService, "heartbeatTimeoutSeconds", 60L);
    }
    ...
    class WhenUpdatingHeartbeat {
        ...
        void shouldTrackHeartbeatInMemoryWithoutDbWrite() {
            // Act
            sensorMonitorService.updateHeartbeat("sensor-1");
    ...
    class WhenCheckingOfflineSensors {
        ...
        void shouldMarkSensorAsOfflineWhenTelemetryReportsOffline() {
            ...
            // Act
            List<Sensor> result = sensorMonitorService.checkOfflineSensors();
        ...
        void shouldIncludeLatencyInDtoWhenSensorComesOnline() {
            ...
            // Act
            sensorMonitorService.checkOfflineSensors();
    ...
    class WhenGettingAllSensors {
        ...
        void shouldReturnAllSensorsFromRepository() {
            ...
            // Act
            List<Sensor> result = sensorMonitorService.getAllSensors();
        ...
        void shouldUseReadOnlyTransaction() {
            ...
            // Act
            sensorMonitorService.getAllSensors();
